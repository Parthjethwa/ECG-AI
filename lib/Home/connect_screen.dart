...
import 'package:ecgai/widgets.dart';
...
import 'package:syncfusion_flutter_charts/charts.dart';
import 'package:csv/csv.dart';
import 'package:ecg_app/widgets.dart';
import 'package:permission_handler/permission_handler.dart';
...
/*currentDataSet = baseData3;
  ...
  void _dataParser(ECGString){
    X++;
   */
/* var temp = int.parse(ECGString.length.toString()*//*
*/
/*ECGString[3].toRadixString(16).padLeft(2, '0')+ECGString[2].toRadixString(16).padLeft(2, '0')+ECGString[1].toRadixString(16).padLeft(2, '0')+ECGString[0].toRadixString(16).padLeft(2, '0'), radix: 16*//*
*/
/*);
    X = temp;*//*

    var temp = int.parse(ECGString.length.toString()*/
/*ECGString[5].toRadixString(16).padLeft(2, '0')+ECGString[4].toRadixString(16).padLeft(2, '0')+ECGString[3].toRadixString(16).padLeft(2, '0')+ECGString[2].toRadixString(16).padLeft(2, '0'), radix: 16*//*
);
    graph1 = temp.toDouble();
    ...
    timestamp = X++;
  */
/*  temp = int.parse(ECGString.toString()*//*
*/
/*ECGString[11].toRadixString(16).padLeft(2, '0')+ECGString[10].toRadixString(16).padLeft(2, '0')+ECGString[9].toRadixString(16).padLeft(2, '0')+ECGString[8].toRadixString(16).padLeft(2, '0'), radix: 16*//*
*/
/*);
    *//*
*/
